...
class QTraffic:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QTraffic', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'QTraffic - Traffic Emission Modelling'),
            callback=self.run,
