...
class Ui_qtraffic_dockWidget(object):
    def setupUi(self, qtraffic_dockWidget):
        ...
        qtraffic_dockWidget.resize(846, 509)
        ...
        self.project_next_PButton = QtGui.QPushButton(self.project_tab)
        self.project_next_PButton.setObjectName(_fromUtf8("project_next_PButton"))
        self.horizontalLayout_22.addWidget(self.project_next_PButton)
        ...
        self.inputNetwork_next_PButton = QtGui.QPushButton(self.input_tab)
        self.inputNetwork_next_PButton.setObjectName(_fromUtf8("inputNetwork_next_PButton"))
        self.horizontalLayout_2.addWidget(self.inputNetwork_next_PButton)
        ...
        self.vehicle_next_PButton = QtGui.QPushButton(self.vehicle_tab)
        self.vehicle_next_PButton.setObjectName(_fromUtf8("vehicle_next_PButton"))
        self.horizontalLayout_5.addWidget(self.vehicle_next_PButton)
        ...
        spacerItem7 = QtGui.QSpacerItem(20, 105, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem7)
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        spacerItem8 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem8)
        self.fleetComposition_next_PButton = QtGui.QPushButton(self.fleetComposition_tab)
        self.fleetComposition_next_PButton.setObjectName(_fromUtf8("fleetComposition_next_PButton"))
        self.horizontalLayout_6.addWidget(self.fleetComposition_next_PButton)
...
"}"))
        ...
        spacerItem9 = QtGui.QSpacerItem(20, 124, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.parameters_next_PButton = QtGui.QPushButton(self.parameters_tab)
        self.parameters_next_PButton.setObjectName(_fromUtf8("parameters_next_PButton"))
        self.horizontalLayout_13.addWidget(self.parameters_next_PButton)
...
"}"))
        ...
        self.pollutantsSO2_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsSO2_CBox.setObjectName(_fromUtf8("pollutantsSO2_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsSO2_CBox, 2, 0, 1, 1)
        self.pollutantsNOx_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsNOx_CBox.setObjectName(_fromUtf8("pollutantsNOx_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsNOx_CBox, 2, 1, 1, 1)
        self.pollutantsCH4_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsCH4_CBox.setObjectName(_fromUtf8("pollutantsCH4_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsCH4_CBox, 3, 1, 1, 1)
        self.pollutantsVOC_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsVOC_CBox.setObjectName(_fromUtf8("pollutantsVOC_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsVOC_CBox, 3, 0, 1, 1)
        self.pollutantsPM10_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsPM10_CBox.setObjectName(_fromUtf8("pollutantsPM10_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsPM10_CBox, 1, 1, 1, 1)
        self.pollutantsCO2_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsCO2_CBox.setObjectName(_fromUtf8("pollutantsCO2_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsCO2_CBox, 0, 1, 1, 1)
        self.pollutantsPM25_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsPM25_CBox.setObjectName(_fromUtf8("pollutantsPM25_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsPM25_CBox, 1, 0, 1, 1)
        self.pollutantsCO_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsCO_CBox.setObjectName(_fromUtf8("pollutantsCO_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsCO_CBox, 0, 0, 1, 1)
        self.pollutantsC6H6_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsC6H6_CBox.setObjectName(_fromUtf8("pollutantsC6H6_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsC6H6_CBox, 3, 2, 1, 1)
        self.pollutantsN2O_CBox = QtGui.QCheckBox(self.groupBox_4)
        self.pollutantsN2O_CBox.setObjectName(_fromUtf8("pollutantsN2O_CBox"))
        self.gridLayout_2.addWidget(self.pollutantsN2O_CBox, 0, 2, 1, 1)
...
"}"))
        ...
        self.gridLayout_4.addWidget(self.fuelEnergyConsumptionDiesel_CBox, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.fuelEnergyConsumptionGAsoline_CBox, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.fuelEnergyConsumptionAlternative_CBox, 3, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.fuelEnergyConsumptionLPG_CBox, 2, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.energyConsumption_CBox, 3, 1, 1, 1)
    ...
    def retranslateUi(self, qtraffic_dockWidget):
        ...
        self.inputNetwork_next_PButton.setText(_translate("qtraffic_dockWidget", "Next ->", None))
        ...
        self.vehicle_next_PButton.setText(_translate("qtraffic_dockWidget", "Next ->", None))
        ...
        self.fleetComposition_next_PButton.setText(_translate("qtraffic_dockWidget", "Next ->", None))
        ...
        self.parameters_next_PButton.setText(_translate("qtraffic_dockWidget", "Next ->", None))
        ...
        self.pollutantsVOC_CBox.setText(_translate("qtraffic_dockWidget", "VOC", None))
        self.pollutantsPM10_CBox.setText(_translate("qtraffic_dockWidget", "PM 10", None))
        ...
        self.energyConsumption_CBox.setText(_translate("qtraffic_dockWidget", "Energy consuption", None))
